...
data_55S_avg = table2struct(data_55T); % change it back to struct array if necessary
...
data_99S_avg = table2struct(data_99T); % change it back to struct array if necessary
...
data_198S_avg = table2struct(data_198T); % change it back to struct array if necessary
...
data_299S_avg = table2struct(data_299T); % change it back to struct array if necessary
...
data_395S_avg = table2struct(data_395T); % change it back to struct array if necessary
...
data_798S_avg = table2struct(data_798T); % change it back to struct array if necessary
